...
with st.sidebar:
    ...
    uploaded_file = st.file_uploader("Sube un txt y la ppt se generará en base a su contenido", type=["txt"])

    modelo = st.selectbox("Modelo", ["llama-3.1-70b-versatile", "llama3-70b-8192", "mixtral-8x7b-32768"])

    max_tokens = st.selectbox("Tokens de salida", [4096, 2048, 1024])  
...
def generar_presentacion():
    ...
    Comienza -el primer slide- con una introducción general motivadora y un resumen persuasivo de toda la presentacón, 
    en dos o tres bloques de texto con saltos de línae.
    ...
    más importante y para que la lectura no se torne monótona, que no sean similares todos los slides.
    ...
    En el ultimo slide -en el que expones las conclusiones- anexa al contenido alguna frase reconocida que tenga
    relación analógica o metafórica con el informe, cita su autor.  
